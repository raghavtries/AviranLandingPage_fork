...
const TABS = [
  ...
  },
  {
    ...
    headline: 'See exactly what changed and why it won.',
    body: 'Every candidate config is evaluated against held-out traces. Aviran surfaces a structured diff so you understand what the optimizer found.',
    bullets: [
      'Side-by-side config diff with score impact',
      'Candidate scored on held-out production traffic',
      'Full lineage: which cluster drove which fix',
    ],
